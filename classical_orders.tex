...
\begin{defn}
Let $A$ be a maximal $R$-order in $D$.  We define the \vocab{ramification index} $e = e(D/K)$ of $D$ over $K$ to be the unique integer $e$ satisfying $J(A)^e = \pi A$.  We define the \vocab{inertial degree} $f = f(D/K)$ to be $f = \dim_k(A/\pi A)$.
\end{defn}
