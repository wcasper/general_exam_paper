...
\end{remk}
%\marginpar{Should work through this at least once...}
...
\begin{defn}
Let $X$ be a scheme.  We define the \vocab{cohomological Brauer group} $\Br'(X)$ of $X$ to be the torsion component of $H^2(X,\bbg_m)$.
\end{defn}
...
% \marginpar{Details missing?  Why is $H^1(X,\bbpgl_n)\rightarrow H^2(X,\mu_n)$ surjective? It's not (not all $n$-torsion is rank $n$)!!!  However, $\bigcup_n H^1(X,\bbpgl_n)\rightarrow H^2(X,\bbg_m)$ is injective: gille and szamuely or serre local fields.}
\item
